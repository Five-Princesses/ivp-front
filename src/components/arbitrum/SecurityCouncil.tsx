...
import { SECURITY_COUNCIL_CONTENTS } from '../../constants/arbitrum/contents';
...
const createLink = (address: string, isL1: boolean) =>
  isL1
    ...
    : API_URLS.getArbiscanAddressUrl(address);
                        ...
                        {l1TransactionHash ? (
                          ...
                          >
                            ...
                            {formatTransactionHash(l1TransactionHash) ? (
                              <Link
                                href={API_URLS.getEtherscanTxUrl(
                                  l1TransactionHash
                                )}
                                target="_blank"
                                rel="noopener noreferrer"
                        ...
                        {l2TransactionHash ? (
                          ...
                          >
                            ...
                            {formatTransactionHash(l2TransactionHash) ? (
                              <Link
                                href={API_URLS.getArbiscanTxUrl(
                                  l2TransactionHash
                                )}
                                target="_blank"
                                rel="noopener noreferrer"
